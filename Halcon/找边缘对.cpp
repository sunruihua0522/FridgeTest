...
void action()
{
  ...
  //mean_image (Image11117455Cam0, Image11117455Cam0, 3, 3)
  ...
  //RoiTuple := [Row, Column, Phi, Length1, Length2]
  ...
  for (hv_Index=1; hv_Index.Continue(end_val41, step_val41); hv_Index += step_val41)
  {
    ...
    MeasurePairs(ho_Image11117455Cam0, hv_MeasureHandle, 1.5, 30, "negative_strongest", 
  ...
  //dev_set_part (762, 1354, 1032, 1709)
  if (HDevWindowStack::IsOpen())
    DispObj(ho_Image11117455Cam0, HDevWindowStack::GetActive());
  ...
  //for Index1 := 0 to |RowFirstList|-1 by 1
    ...
    //disp_cross (WindowHandle, RowSecondList[Index1], ColSecondList[Index1], 6, Phi)
  //endfor
  ...
  DispLine(hv_WindowHandle, hv_RowBegin1, hv_ColBegin1, hv_RowEnd1, hv_ColEnd1);
