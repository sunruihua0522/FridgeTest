...
void action()
{
  ...
  // Local iconic variables
  HObject  ho_Image, ho_Image11117455Cam0, ho_Regions1;
  ...
  MeanImage(ho_Image, &ho_Image11117455Cam0, 3, 3);
  if (HDevWindowStack::IsOpen())
  ...
  //spoke_paras := [30,15,5,1,5,'negative', 'first']
  ...
  ReadTuple(hv_PreFile+"sopkeParaRow.tup", &hv_ROIRows);
  ReadTuple(hv_PreFile+"sopkeParaCol.tup", &hv_ROICols);
  ReadTuple(hv_PreFile+"sopkeParaDir.tup", &hv_Direct);
